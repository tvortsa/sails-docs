...
Конфигурация для глобальных переменных Sails предоставляет процесс Node.  Cv [`sails.config.globals`](http://sailsjs.com/documentation/reference/configuration/sails-config-globals) for a detailed overview of all available options.
